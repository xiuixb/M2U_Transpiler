...
INPUT_FILE = PROJECT_ROOT / "data" / "MILO_new" / "milo_new.m2d"
...
class TestBWO1Services(unittest.TestCase):
    ...
    def test_01_initialize_returns_system_state(self):
        ...
        self.assertTrue(state["system_config_path"].endswith(r"src\infrastructure\sys_config.json"))
    ...
    def test_02_select_device_creates_workdir_and_device_config(self):
        ...
        self.assertEqual(state["device_name"], DEVICE_NAME)
        ...
        self.assertEqual(sys_config["last_device_name"], DEVICE_NAME)
    ...
    def test_03_load_device_config_contains_expected_sections(self):
        ...
        self.assertEqual(config["device_name"], DEVICE_NAME)
    ...
    def test_04_artifact_service_can_list_known_artifacts(self):
        ...
        self.assertIn("mid_round1", artifact_keys)
        self.assertIn("uni_symbols", artifact_keys)

    def test_05_artifact_service_can_save_and_read_json(self):
        content = json.dumps({"device": DEVICE_NAME, "ok": True}, ensure_ascii=False, indent=2)
        ...
        self.assertEqual(json.loads(read_result["content"])["device"], DEVICE_NAME)
