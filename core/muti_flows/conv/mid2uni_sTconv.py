...
from core.symbolBase import MagicSymbolTable, MidSymbolTable, Unipic25dSymbolTable
...
class MID2UNI_STConv():
    ...
    def mid2FaceBndIn(self,
        ...
        print(f"[info] Saving FaceBndIn.in")
    ...
    def mid2PtclSourcesIn(self,                          
        ...
        print(f"[info] Saving PtclSources.in")
    ...
    def mid2SpeciesIn(self,
        ...
        print(f"[info] Saving Species.in")
        SpeciesIn = {
            "sys_type":"xml",
            "xml_type": "Species",
            "xml_name": "Species",
            "content" : [{
                "sys_type":"ini",
                "charge": "-1.6022e-19", "mass": "9.109e-31", "ptclCreationRate": 3.0, "kind": "electron", "name": "Species"
            }]
        }
    ...
    def mid2FieldsDgnIn(self,
        ...
        print(f"[info] Saving FieldsDgn.in")
    ...
    def mid2StaticNodeFLdsIn(self, rMax: float):
        ...
        print(f"[info] Saving StaticNodeFLds.in")
        print(f"       rMax = {rMax}")
    ...
    def mid2CircuitModelIn(self,
        ...
        print(f"[info] Saving CircuitModel.in")
    ...
    def mid2GlobalSettingIn(self,
        ...
        print(f"[info] Saving GlobalSetting.in")
        runtime = self.mid_symbols.symbol_table["RUNTIME"]["value"]
